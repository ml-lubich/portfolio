...
export async function checkModelStatus(model: string, apiKey: string): Promise<ModelStatus> {
...
export async function checkAllModels(models: readonly string[], apiKey: string): Promise<ModelStatus[]> {
