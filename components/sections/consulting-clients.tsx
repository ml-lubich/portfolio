...
export function ConsultingClients() {
  ...
  const clientCards = consultingClients.map((client) => {
    ...
    const heroSlot =
      "relative z-[1] h-[150px] w-full shrink-0 overflow-hidden border-b border-white/[0.08] sm:h-[180px]"
    ...
    const inner = (
      <>
        ...
        <div className="relative z-[2] flex min-h-0 flex-1 flex-col space-y-3 p-5 sm:p-6">
          ...
          <p className="line-clamp-3 text-sm leading-relaxed text-muted-foreground/85 sm:text-[15px]">
            {client.summary}
          </p>

          {client.quote ? (
            <blockquote className="line-clamp-2 border-l-2 border-primary/30 pl-3 text-sm leading-relaxed text-foreground/75">
              “{client.quote}”
            </blockquote>
          ) : null}
  ...
  return (
    <AnimatedSection
      id="consulting"
      className="relative mx-auto max-w-6xl scroll-mt-28 px-3 py-8 pb-10 md:px-6 md:py-20 md:pb-24 lg:py-28 lg:pb-32"
    >
      ...
      <SectionHeader
        ...
        subtitle="Senior, hands-on engineering for founders and growing teams: AI systems, web products, integrations, automation, and the difficult production work between an idea and a reliable launch."
      />
      ...
      <div className="mx-auto mb-8 max-w-2xl text-center sm:mb-10">
        <p className="text-sm leading-relaxed text-muted-foreground sm:text-[15px]">
          ...
          {" "}
          for a focused technical consultation, a complete build, or help stabilizing an existing system. Engagements are scoped around outcomes, with clear ownership and direct access to the engineer doing the work.
        </p>
        <a
          href="https://calendar.app.google/T2VGkBsBAUzGABRB7"
          target="_blank"
