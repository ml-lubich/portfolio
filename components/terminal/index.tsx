...
export function LiveTerminal() {
  ...
  const [terminalMode, setTerminalMode] = useState<TerminalMode>("live")
  ...
  useEffect(() => {
    if (!visible || terminalMode !== "live") return
  ...
  return (
    <AnimatedSection id="terminal" className="relative overflow-hidden px-3 pb-8 pt-4 md:px-6 md:pb-16 md:pt-8 lg:pb-20">
