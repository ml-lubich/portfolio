...
export const CHAIN_TRIM_BEHIND = 16

/** How far behind (in edges) the glow trail extends */
export const TRAIL_LENGTH = 14.0

/** Ambient rainbow base intensity on all edges (0–1) */
export const AMBIENT_RAINBOW = 0.04

/** How much to mix rainbow colors toward greyish-white (0 = full rainbow, 1 = pure white) */
export const WHITE_MIX = 0.72
