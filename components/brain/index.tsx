...
function getInitialCam() {
  ...
  /* Close dolly + slightly wider FOV so the mesh fills the hero underlay. */
  if (w < 480) return { z: 1.45, fov: 48 }
  if (w < 640) return { z: 1.55, fov: 47 }
  if (w < 1024) return { z: 1.75, fov: 45 }
