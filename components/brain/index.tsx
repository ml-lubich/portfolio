...
function getInitialCam() {
  ...
  /* Pull back enough to keep the complete silhouette inside every viewport. */
  if (w < 480) return { z: 2.35, fov: 48 }
  if (w < 640) return { z: 2.35, fov: 47 }
  if (w < 1024) return { z: 2.45, fov: 45 }
  return { z: 2.35, fov: 44 }
}
